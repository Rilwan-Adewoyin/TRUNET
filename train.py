...
def train_loop(train_params, model_params): 
    ...
    if model_params['model_type_settings']['discrete_continuous'] == True:
        ...
        if model_params['model_type_settings']['model_version'] in ["54","55","56","155"]:
            ...
            optimizer_rain      = tfa.optimizers.RectifiedAdam( **{"learning_rate":1.5e-3, "warmup_proportion":0.75, "min_lr":1e3, "beta_1":0.05, "beta_2":0.85, "decay":0.004, "amsgrad":True, "epsilon":1e-3} , total_steps=total_steps ) 
