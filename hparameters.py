...
class model_TRUNET_hparameters(MParams):
    ...
    def _default_params( self, **kwargs ):
        ...
        REC_ADAM_PARAMS = {
            "learning_rate":1e-2,   "warmup_proportion":0.65,
            "min_lr":8e-3,         "beta_1":0.8,               "beta_2":0.99,
            "amsgrad":True,         "decay":0.0008,              "epsilon":1e-8 } #Rectified Adam params  

        LAMB_PARAMS = {
            "learning_rate":1e-2, "beta_1":0.9, "beta_2":0.99,
            "epsilon":1e-8, "decay":0.0009,
        }          
