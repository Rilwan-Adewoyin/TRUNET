...
class model_THST_hparameters(MParams):
    ...
    def _default_params( self, **kwargs ):
        ...
        REC_ADAM_PARAMS = {
            "learning_rate":3e-3, "warmup_proportion":0.75,
            "min_lr":1e-4, "beta_1":0.80 , "beta_2":0.95,
            "amsgrad":True, "decay":0.003, "epsilon":5e-3 }
...
class model_SimpleGRU_hparameters(MParams):
    ...
    def _default_params(self, **kwargs):
        ...
        REC_ADAM_PARAMS = {
            ...
            "min_lr":8e-4, "beta_1":0.55, "beta_2":0.95, "decay":0.005,
...
class model_SimpleConvGRU_hparamaters(MParams):
    ...
    def _default_params(self,**kwargs):
        ...
        #training proc
        REC_ADAM_PARAMS = {
            "learning_rate":1e-3 , "warmup_proportion":0.75,
            "min_lr":3e-4, "beta_1":0.65, "beta_2":0.95, "decay":0.006, "amsgrad":True,
            'epsilon':0.005
            }
